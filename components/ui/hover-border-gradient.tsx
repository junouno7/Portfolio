  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
            background: hovered
              ? [movingMap[0], highlight] // Fast switch to blue on hover
              : [highlight, ...movingMap], // blue to white
            //   : movingMap,
               
          }}
          transition={{
            ease: "linear",
            duration: hovered ? duration : slowDuration, // Fast on hover, slow when idle
